...
// Action-oriented: "what do I need to do." History/chronology lives on the
// Timeline tab instead -- this screen only answers today's question.
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <section className="flex flex-col gap-3">
        <h2 className="text-sm font-medium text-[var(--text-dim)]">Follow-ups due</h2>
      ...
      <section className="flex flex-col gap-3">
        <h2 className="text-sm font-medium text-[var(--text-dim)]">Open hotspots, by severity</h2>
        {active.length === 0 ? (
