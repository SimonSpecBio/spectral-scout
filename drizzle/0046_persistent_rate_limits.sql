...
CREATE INDEX "scout_rate_limit_bucket_expires_at_idx" ON "scout_rate_limit_bucket" USING btree ("expires_at");--> statement-breakpoint
ALTER TABLE "scout_rate_limit_bucket" ENABLE ROW LEVEL SECURITY;